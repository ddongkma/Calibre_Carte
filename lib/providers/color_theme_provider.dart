...
class ColorTheme with ChangeNotifier {
  late bool _darkMode;
  late Color _tileColor1;
  late Color _tileColor2;
  late Color _descriptionBackground;
  late Color _settingsBackground;
  late Color _settingsTile;
  late Color _headerText;
  late Color _subHeaderText;
  late Color _iconColor = Color(0xffFED962);
  late Color _di;
  late Color _appBarColor;
  late Color _appBarTitleColor;
  late Color _modalSheetColor = Colors.white.withOpacity(0.8);
  late Color _alertBoxColor;
  late Color _tileUnderlineColor;
  late Color _descriptionIconAltColor;
  late Color _descriptionIconColor;
  late Color _descriptionIconEnabled;
  late Color _descriptionArrow;
  late Color _descriptionArrowBackground;
  late Color _settingsIcon;

  late Color _directoryPickerText;
  late Color _directoryPickerBg;

  late Color _progressBar;
