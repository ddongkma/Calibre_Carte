...
import 'package:calibre_carte/common/widgets/book_details_cover_image.dart';
import 'package:calibre_carte/common/widgets/download_icon.dart';
import 'package:calibre_carte/helpers/slide_transition_route.dart';
import 'package:calibre_carte/helpers/text_style.dart';
import 'package:calibre_carte/pages/book_details/book_details_screen.dart';
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        height: 2.0,
                        width: 18.0,
                        color: colorTheme.tileUnderlineColor,
                      ),
                      Container(
                        height: 2,
                      ),
