import 'package:calibre_carte/pages/setting/widgets/dropbox_dropdown.dart';
...
class _CloudSettingsState extends State<CloudSettings> {
  ...
  Widget _settingsCard(
      ColorTheme colorTheme, settingName, settingIcon,void Function() onClicked) {
    return Theme(
      data: ThemeData(
          unselectedWidgetColor: colorTheme.headerText, hintColor: Colors.grey,dividerColor: Colors.transparent),
      child: ExpansionTile(
        title: Container(
          child: InkWell(
            onTap: onClicked,
